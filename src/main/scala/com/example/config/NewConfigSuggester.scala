...
import com.example.model.{Field, FieldMapping, StandardField}
...
/**
  ...
  * Equivalent means they refer to the same [[com.example.model.StandardField]].
  */
object NewConfigSuggester {
  val DEFAULT_VALUE_FOR_EMPTY_VALUES = ""

  // TODO type-safe compare types maybe?
  /**
